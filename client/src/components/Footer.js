    ...
    <footer className='pt-16 bg-primary'>
      <div className='container mx-auto'>
        <div className='text-center'>
          ...
          <p className='text-white/70'>Be the first to get the lastest news about trends, promotions and much more!</p>
        </div>
        {/* form */}
        ...
        <div className='text-base text-white/60 flex gap-x-6 capitalize max-w-max mx-auto mb-9'>
          <a href='#' className='hover:text-white transtion-all'>
            Returns policy
          </a>
          <a href='#' className='hover:text-white transtion-all'>
            Track your order
      ...
      <div className='py-10 border-t border-t-white/10'>
        <div className='container mx-auto'>
          <div className='text-center text-sm text-white/60'>
            Copyright &copy; Photoland 2024. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
